  ...
  render(props) {
    return (
      <div className="Description">
        <div className="WeaponsDescriptionTitle">
          <em>Description Weapons :</em>
        </div>
        <div className="allIcon">
        <div className="WeaponsContainerIconsD">
          <div>
...
Description.contextType = AppContext;
